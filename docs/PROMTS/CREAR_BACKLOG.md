Usando el archivo IMPLEMENTATION_PLAN como única fuente de verdad, genera el backlog detallado exclusivamente para la Fase .
...
Limítate estrictamente al alcance definido para la Fase x.
...
Quiero únicamente el backlog ejecutable de la Fase  para que pueda comenzar a trabajar inmediatamente.
